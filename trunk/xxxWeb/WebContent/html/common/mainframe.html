...
<body>
<div id="nav">
    <ul><li id="man_nav_1" onclick="list_sub_nav(id,'管理首页')"  class="bg_image_onclick">管理首页</li><li id="man_nav_2" onclick="list_sub_nav(id,'系统设置')"  class="bg_image">系统设置</li><li id="man_nav_3" onclick="list_sub_nav(id,'账户管理')"  class="bg_image">账户管理</li><li id="man_nav_4"  onclick="list_sub_nav(id,'易货管理')"  class="bg_image">易货管理</li><li id="man_nav_5"  onclick="list_sub_nav(id,'广告新闻')"  class="bg_image">广告新闻</li></ul>
</div>
<div id="sub_info">&nbsp;&nbsp;<img src="images/hi.gif" />&nbsp;<span id="show_text">欢迎使用无忧易货网后台管理系统!</span></div>
</body>
</html>
