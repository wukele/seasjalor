...
Ext.form.VTypes = function() {
	var C = /^[a-zA-Z_]+$/;
	var D = /^[a-zA-Z0-9_]+$/;
	var F= /^[0-9-]+$/;//自定义用于电话号码校验
	var G= /^[a-zA-Z0-9]+$/;//自定义只能用于输入字母和数字，不能输入_
	...
	//自定义开始	
		...
		"phoneText" : "This field should only contain 0-9 and -",
		"phoneMask" : /[0-9-]/i,
		"alphaandnum" : function(E) {
			return G.test(E)
		},
		"alphaandnumText" : "This field should only contain letters, numbers",
		"alphaandnumMask" : /[a-z0-9]/i,
	//自定义结束	
		"alphanum" : function(E) {
			return D.test(E)
		},
